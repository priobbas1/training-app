...
function WorkoutElement({ workout, setWorkouts }) {
  ...
  const toggleLike = async (e) => {
    ...
    try {
      (await workout.fav) ? dislikeWorkout(workout.id) : likeWorkout(workout.id);
      const newFavValue = workout.fav === 1 ? 0:1;
